...
try {
    ...
    $mail->SMTPSecure = 'ssl';
    $mail->Port       = 465;
    $mail->setFrom('art.dev.k@gmail.com', 'Магазин Надежда'); // Адрес самой почты и имя отправителя
...
if (!empty($_FILES['myfile']['name'][0])) {
    for ($ct = 0; $ct < count($_FILES['myfile']['tmp_name']); $ct++) {
        ...
        $mail->Body    = "<b>Вопрос:</b> $userName <br>
                          <b>Почта:</b> $userEmail";
